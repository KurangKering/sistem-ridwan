...
def index_data_latih_kiper(request):
	"""
	...
	"""
	return render (request, 'data-latih-kiper/index.html')



@csrf_exempt
def detail_data_latih_kiper(request):
...
@csrf_exempt
def create_or_update_data_latih_kiper(request):

	id_data_latih = request.POST.get('id')

	if (id_data_latih == '' or id_data_latih == None):
		context = insert_data_latih_kiper(request)
	else:
		context = update_data_latih_kiper(request)

	return JsonResponse(context, safe=False)


@csrf_exempt
def insert_data_latih_kiper(request):
...
@csrf_exempt
def update_data_latih_kiper(request):
	form = DataLatihKiperForm(request.POST)
...
@csrf_exempt
def delete_data_latih_kiper(request):
    id_data_latih_kiper = request.POST.get('id')
    data_latih_kiper = DataLatihKiper.objects.get(pk=id_data_latih_kiper)
...
@csrf_exempt
def import_data_latih_kiper(request):
...
def index_pengujian_kiper(request):
	"""
	{ function_description }
	...
	:type       request:  { type_description }
	"""
	return render(request, 'pengujian-kiper/index.html')

@csrf_exempt
def proses_pengujian_kiper(request):
...
def proses_pengujian_tunggal(request):
	"""
	{ function_description }
